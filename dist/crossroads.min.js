...
compilePattern:function(a){if(a=a||"")a=a.replace(f,""),a=e(a),a=a.replace(d,"\\$&"),a=a.replace(v,"\\/?"),a=a.replace(w,"\\/"),a=a.replace(n,"([^\\/]+)?/?"),a=a.replace(m,"([^\\/]+)");return RegExp("^"+a+"/?$")},composePath:function(a,d){a=a||"";d=d||{};if(a)var f=b(a),a=e(a),a=a.replace(s,function(a,b,e){switch(a){case r:var g=d,h=f.shift(),g=g[h];if(!g)throw Error('Missing parameter "'+h+'"');return g+c(a,b,e);case q:return h=d[f.shift()],(h?"/"+h:"")+c(a,b,e);case p:return"/";case o:return"";
default:throw Error("Unexpected token");}});return a}}}();return f})})(typeof define==="function"&&define.amd?define:function(j,f){typeof module!=="undefined"&&module.exports?module.exports=f(require):window[j]=f(function(f){return window[f]})});