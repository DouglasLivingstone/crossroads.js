...
this._pattern+'", numListeners:'+this.matched.getNumListeners()+"]"}};g=f.patternLexer=function(){function a(a,b){for(var c=[],d;d=a.exec(b);)c.push(d[1]);return c}function b(t){return a(l,t)}function c(a,b,c){a=c.substr(b+a.length);return a===""||a.indexOf("/")===0||a.search(s)===0?"":"/"}function e(a){a=a.replace(g,"$1"+o+"$2");a=a.replace(h,"$1"+p+"$2");a=a.replace(k,q);return a.replace(i,r)}var d=/[\\.+*?\^$\[\](){}\/'#]/g,f=/\/$/g,g=/([:}]|\w(?=\/))\/?(:)/g,h=/([:}])\/?(\{)/g,i=/\{([^}]+)\}/g,
k=/:([^:]+):/g,l=/(?:\{|:)([^}:]+)(?:\}|:)/g,r="__CR_RP__",q="__CR_OP__",p="__CR_RS__",o="__CR_OS__",m=RegExp(r,"g"),n=RegExp(q,"g"),u=RegExp(o,"g"),v=RegExp(p,"g"),s=RegExp(r+"|"+q+"|"+o+"|"+p,"g");return{getParamIds:b,getOptionalParamsIds:function(b){return a(k,b)},getParamValues:function(a,b,c){if(a=b.exec(a))if(a.shift(),c){c=a;a=c.length;for(b=[];a--;)b[a]=j(c[a]);a=b}return a},compilePattern:function(a){if(a=a||"")a=a.replace(f,""),a=e(a),a=a.replace(d,"\\$&"),a=a.replace(u,"\\/?"),a=a.replace(v,
"\\/"),a=a.replace(n,"([^\\/]+)?/?"),a=a.replace(m,"([^\\/]+)");return RegExp("^"+a+"/?$")},composePath:function(a,d){a=a||"";d=d||{};if(a)var f=b(a),a=e(a),a=a.replace(s,function(a,b,e){switch(a){case r:var g=d,h=f.shift(),g=g[h];if(!g)throw Error('Missing parameter "'+h+'"');return g+c(a,b,e);case q:return h=d[f.shift()],(h?"/"+h:"")+c(a,b,e);case p:return"/";case o:return"";default:throw Error("Unexpected token");}});return a}}}();return f})})(typeof define==="function"&&define.amd?define:function(j,
f){typeof module!=="undefined"&&module.exports?module.exports=f(require):window[j]=f(function(f){return window[f]})});